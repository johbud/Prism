...
from Prism_InDesign_Functions import Prism_InDesign_Functions
from Prism_InDesign_Integration import Prism_InDesign_Integration


class Prism_Plugin_InDesign(
    Prism_InDesign_Variables,
    Prism_InDesign_externalAccess_Functions,
    Prism_InDesign_Functions,
    ...
    def __init__(self, core):
        ...
        Prism_InDesign_Functions.__init__(self, core, self)
