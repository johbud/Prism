...
class Prism_Illustrator_Integration(object):
    def __init__(self, core, plugin):
        ...
        if platform.system() == "Windows":
            self.examplePath = (
                os.environ["userprofile"] + "\\Documents\\Illustrator\\2019"
            )
            ...
            self.examplePath = os.path.join("/home", userName, "Illustrator", "2019")
            ...
            self.examplePath = (
                "/Users/%s/Library/Preferences/Autodesk/Illustrator/2019" % userName
            )
    ...
    def getExecutable(self):
        execPath = ""
        if platform.system() == "Windows":
            defaultpath = os.path.join(self.getIllustratorPath(), "Illustrator.exe")
    ...
    def installerExecute(self, pluginItem, result):
        try:
            ...
            for i in pluginPaths:
                result["Illustrator integration"] = self.core.integration.addIntegration(self.plugin.pluginName, path=i, quiet=True)
