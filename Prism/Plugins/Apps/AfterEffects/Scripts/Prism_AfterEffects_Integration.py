...
class Prism_AfterEffects_Integration(object):
    def __init__(self, core, plugin):
        ...
        if platform.system() == "Windows":
            self.examplePath = (
                os.environ["userprofile"] + "\\Documents\\AfterEffects\\2019"
            )
            ...
            self.examplePath = os.path.join("/home", userName, "AfterEffects", "2019")
            ...
            self.examplePath = (
                "/Users/%s/Library/Preferences/Autodesk/AfterEffects/2019" % userName
            )
    ...
    def getExecutable(self):
        execPath = ""
        if platform.system() == "Windows":
            defaultpath = os.path.join(self.getAfterEffectsPath(), "AfterEffects.exe")
